...
export interface ApiAbsenceDelegationAbsenceDelegation
  extends Struct.CollectionTypeSchema {
  collectionName: 'absence_delegations';
  info: {
    displayName: 'Absence Delegation';
    pluralName: 'absence-delegations';
    singularName: 'absence-delegation';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delegateUser: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::absence-delegation.absence-delegation'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sourceAbsenceDocumentId: Schema.Attribute.String &
      Schema.Attribute.Required;
...
export interface ApiCatSheetCatSheet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tarification: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiDonationDonation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.Enumeration<
      ['helloasso', 'cash', 'bank_transfer', 'other']
    > &
      Schema.Attribute.Required &
...
export interface ApiTarificationTarification
  extends Struct.CollectionTypeSchema {
